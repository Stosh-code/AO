...
gauss_0 = GaussianBeam(N, N*dx, N*dx, N*dx/30, x_0=N*dx/5)
gauss_1 = GaussianBeam(N, N*dx, N*dx, N*dx/30, x_0=-N*dx/5)
gauss_2 = GaussianBeam(N, N*dx, N*dx, N*dx/30, x_0=0, y_0=N*dx/5)
E = 4*gauss_0.E*np.exp(1j*phase_0) + 4*gauss_1.E*np.exp(1j*0) + 4*gauss_2.E*np.exp(1j*0)
